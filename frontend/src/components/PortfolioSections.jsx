    ...
    <div className="container mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {certifications.map((cert) => (
          <Card key={cert.id} className="bg-black/50 border-grey/20 hover:border-light-pink/50 transition-all duration-300">
    ...
    <div className="container mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {achievements.map((achievement) => (
          <Card key={achievement.id} className="bg-light-pink/10 border-light-pink/20 hover:bg-light-pink/15 transition-all duration-300">
            <CardContent className="p-6">
    ...
    <div className="container mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {hobbies.map((hobby) => {
          ...
          return (
            <Card key={hobby.id} className="bg-mid-purple/10 border-mid-purple/20 hover:bg-mid-purple/15 transition-all duration-300 group">
